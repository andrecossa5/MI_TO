...
include { SOLO } from "../sc_pp/modules/Solo.nf"

// 

process publish_tenx_pp {

    publishDir "${params.tenx_pp.outdir}/${sample}/", mode: 'copy'
    ...
    script:
    """
    echo moving everything to ${params.tenx_pp.outdir}
    """
